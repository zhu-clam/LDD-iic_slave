...
#define GV_IPCM_IOC_GET_REMOTE_ID \
	_IOW(GV_IPCM_IOC_BASE, 6, GV_IPCM_HANDLE_ATTR_S)
#define GV_IPCM_IOC_ATTR_INIT \
	_IOW(GV_IPCM_IOC_BASE, 7, GV_IPCM_HANDLE_ATTR_S)
