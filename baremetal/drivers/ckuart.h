...
#define CK_UART_FAR       0x1c    /* FIFO Access Register (32 bits, R/W) */
#define CK_UART_TFR       0x1d    /* Transmit FIFO Read Register (32 bits, R) */
#define CK_UART_RFW       0x1e    /* Receive FIFO Write Register (32 bits, W) */
#define CK_UART_USR       0x1f    /* UART Status Register (32 bits, R/W) */
#define CK_UART_TFL       0x20    /* UART Transmit FIFO Level Register (32 bits, R) */
#define CK_UART_RFL       0x21    /* UART Receive FIFO Level Register (32 bits, R) */
#define CK_UART_SRR       0x22    /* UART Software Reset Register (32 bits, W) */
...
#define CK_UART3_IRQID    CK_INTC_UART3
#define CK_UART4_IRQID    CK_INTC_UART4
...
#define FCR_FIFOE               1 << 0

// bitfields of FAR
#define FAR_FIFO_ACCESS         1 << 0
